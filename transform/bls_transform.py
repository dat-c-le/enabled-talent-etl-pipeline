...
Columns: series_id, series_title, periodicity, disability_status, sex,
         age_group, race, hispanic_origin, labor_force_status,
...
def transform_qcew(
    ...
    # Preserve state_fips as zero-padded 2-char string for ACS joins.
